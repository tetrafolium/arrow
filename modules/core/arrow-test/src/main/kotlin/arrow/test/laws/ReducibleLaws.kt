...
object ReducibleLaws {
    ...
    inline fun <reified F> reduceLeftToConsistentWithReduceMap(RF: Reducible<F>, crossinline cf: (Int) -> Kind<F, Int>, EQ: Eq<Int>) =
        forAll(
    ...
    inline fun <reified F> reduceRightToConsistentWithReduceMap(RF: Reducible<F>, crossinline cf: (Int) -> Kind<F, Int>, EQ: Eq<Int>) =
        forAll(
            genFunctionAToB<Int, Int>(genIntSmall()), genConstructor(genIntSmall(), cf),
            { f: (Int) -> Int, fa: Kind<F, Int> ->
    ...
    inline fun <reified F> reduceRightToConsistentWithReduceRightToOption(RF: Reducible<F>, crossinline cf: (Int) -> Kind<F, Int>, EQ: Eq<Option<Int>>) =
        forAll(
            genFunctionAToB<Int, Int>(genIntSmall()), genConstructor(genIntSmall(), cf),
            { f: (Int) -> Int, fa: Kind<F, Int> ->
    ...
    inline fun <reified F> reduceRightConsistentWithReduceRightOption(RF: Reducible<F>, crossinline cf: (Int) -> Kind<F, Int>, EQ: Eq<Option<Int>>) =
        forAll(
            genFunctionAAToA(genIntSmall()), genConstructor(genIntSmall(), cf),
            { f: (Int, Int) -> Int, fa: Kind<F, Int> ->
    ...
    inline fun <reified F> reduceReduceLeftConsistent(RF: Reducible<F>, crossinline cf: (Int) -> Kind<F, Int>, EQ: Eq<Int>) =
        forAll(
    ...
    inline fun <reified F> sizeConsistent(RF: Reducible<F>, crossinline cf: (Int) -> Kind<F, Int>, EQ: Eq<Long>) =
        forAll(
            genConstructor(genIntSmall(), cf),
            { fa: Kind<F, Int> ->
