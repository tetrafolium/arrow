...
object SetterLaws {
    ...
    inline fun <reified A, reified B> setIdempotent(setter: Setter<A, B>, aGen: Gen<A>, bGen: Gen<B>, EQA: Eq<A>): Unit = forAll(
        aGen, bGen,
        { a, b ->
    ...
    inline fun <reified A, reified B> modifyIdentity(setter: Setter<A, B>, aGen: Gen<A>, EQA: Eq<A>): Unit = forAll(
        aGen,
        { a ->
    ...
    inline fun <reified A, reified B> composeModify(setter: Setter<A, B>, aGen: Gen<A>, EQA: Eq<A>, funcGen: Gen<(B) -> B>): Unit = forAll(
    ...
    inline fun <reified A, reified B> consistentSetModify(setter: Setter<A, B>, aGen: Gen<A>, bGen: Gen<B>, EQA: Eq<A>): Unit = forAll(
        aGen, bGen,
        { a, b ->
