...
): Kind<HKF, Tuple8<A, B, C, D, E, F, G, Z>> =
...
): Kind<HKF, Tuple9<A, B, C, D, E, F, G, H, Z>> =
...
fun <HKF, A, B, C, D, E, F, G, H, I, Z> Kind<HKF, Tuple9<A, B, C, D, E, F, G, H, I>>.product(
    ...
    dummyImplicit6: Any? = null,
    dummyImplicit7: Any? = null,
    dummyImplicit9: Any? = null
): Kind<HKF, Tuple10<A, B, C, D, E, F, G, H, I, Z>> =
...
fun <HKF, A, B, C, D, E, F, G, H> Applicative<HKF>.tupled(
    ...
    g: Kind<HKF, G>,
    h: Kind<HKF, H>
): Kind<HKF, Tuple8<A, B, C, D, E, F, G, H>> =
...
fun <HKF, A, B, C, D, E, F, G, H, I> Applicative<HKF>.tupled(
    ...
    h: Kind<HKF, H>,
    i: Kind<HKF, I>
): Kind<HKF, Tuple9<A, B, C, D, E, F, G, H, I>> =
...
fun <HKF, A, B, C, D, E, F, G, H, I, J> Applicative<HKF>.tupled(
    ...
    i: Kind<HKF, I>,
    j: Kind<HKF, J>
): Kind<HKF, Tuple10<A, B, C, D, E, F, G, H, I, J>> =
    a.product(this, b).product(this, c).product(this, d).product(this, e).product(this, f).product(this, g)
...
fun <HKF, A, B, C, D, E, F, G, H, Z> Applicative<HKF>.map(
    ...
    g: Kind<HKF, G>,
    h: Kind<HKF, H>,
    lbd: (Tuple8<A, B, C, D, E, F, G, H>) -> Z
): Kind<HKF, Z> =
    this.map(
        a.product(this, b).product(this, c).product(this, d).product(this, e).product(this, f)
            .product(this, g).product(this, h),
        lbd
    )
...
fun <HKF, A, B, C, D, E, F, G, H, I, Z> Applicative<HKF>.map(
    ...
    h: Kind<HKF, H>,
    i: Kind<HKF, I>,
    lbd: (Tuple9<A, B, C, D, E, F, G, H, I>) -> Z
): Kind<HKF, Z> =
    this.map(
        a.product(this, b).product(this, c).product(this, d).product(this, e).product(this, f)
            .product(this, g).product(this, h).product(this, i),
        lbd
    )
...
fun <HKF, A, B, C, D, E, F, G, H, I, J, Z> Applicative<HKF>.map(
    ...
    i: Kind<HKF, I>,
    j: Kind<HKF, J>,
    lbd: (Tuple10<A, B, C, D, E, F, G, H, I, J>) -> Z
): Kind<HKF, Z> =
    this.map(
        a.product(this, b).product(this, c).product(this, d).product(this, e).product(this, f)
            .product(this, g).product(this, h).product(this, i).product(this, j),
        lbd
    )
