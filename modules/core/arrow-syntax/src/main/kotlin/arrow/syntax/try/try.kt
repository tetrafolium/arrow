...
fun <A, B, C, D, E, F, G, H, I, J> merge(
    ...
    op9: () -> I,
    op10: () -> J
): Try<Tuple10<A, B, C, D, E, F, G, H, I, J>> =
    Try.applicative().tupled(
        Try.invoke(op1),
        Try.invoke(op2),
        Try.invoke(op3),
